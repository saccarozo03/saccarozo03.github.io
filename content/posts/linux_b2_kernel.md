...
- `(Process Scheduling) Lập lịch quy trình` : Một máy tính có nhiều hơn 1 bộ xử lý trung tâm ( CPU ) , cái mà thực thi các lệnh của chương trình . Giống như các hệ thống UNIX khác , LINUX là một hệ điều hành `đa nhiệm ưu tiên (preemptive multitasking)`
- 